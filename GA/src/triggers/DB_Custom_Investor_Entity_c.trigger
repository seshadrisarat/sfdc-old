trigger DB_Custom_Investor_Entity_c on Investor_Entity__c ( before delete, after insert, after update, after undelete )
{
	try
	{
	...
	{
		CRMfusionDBR101.DB_TriggerHandler.handleTriggerException( ex, 'DB_Custom_Investor_Entity_c' );
	}
}