...
*/
trigger SL_FinancialAccount on Financial_Account__c (after insert,after update, after delete, before delete) 
{
	...
	{
		if(Trigger.isInsert)
			objFinancialAccountHandler.onAfterInsert(Trigger.newMap);
		if(Trigger.isUpdate)
