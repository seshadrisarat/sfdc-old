trigger CallStatisticcStats on Call_Statistic__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('Call_Statistic__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
