trigger OPA05cStats on OPA_05__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('OPA_05__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
