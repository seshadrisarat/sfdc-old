    ...
    try{
        ...
        if (Trigger.isDelete) {
            if (Trigger.old.size() == 1) {
                ...
                audit.ObjectTitle__c = (Trigger.old[0].FirstName + ' ' + Trigger.old[0].LastName);
            } else {
            ...
            if (Trigger.isInsert) {
                if (Trigger.new.size() == 1) {
                    ...
                    audit.ObjectTitle__c = (Trigger.new[0].FirstName + ' ' + Trigger.new[0].LastName);
                } else {
