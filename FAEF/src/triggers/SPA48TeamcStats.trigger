trigger SPA48TeamcStats on SPA_48_Team__c(after insert, after update, after delete, after undelete) {
    try {
      ...
      hoopla.NotifierGlobal.processNotifications('SPA_48_Team__cStats', Trigger.newMap, Trigger.oldMap, changeType);
    }
    catch(Exception e) {
